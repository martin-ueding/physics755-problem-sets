...
\int \frac{\dif^3p}{[2\piup]^3}
    ...
    \intertext{%
        ...
        There is only one function that depends on $\vec x$, and that is the
        exponential. That integration will give me a $\deltaup(\vec p + \vec
        p')$. I can then carry out the integration over $\vec p'$ to eliminate
        it by applying $\vec p' \to - \vec p$.
    }
    &= \int \frac{\dif^3p}{[2\piup]^3} \,
    \sbr{
        -
